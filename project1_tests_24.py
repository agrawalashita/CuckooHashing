...
def cuckoo_hash_tests():
	...
	print("Current table state after insertion:", c.get_table_contents())
	...
	print("Current table state after deletion:", c.get_table_contents())


	ref_ans = [[None, None, [7], None, [6], None, None, [5, 8], None, [9]], [None, None, None, None, None, None, None, None, None, None]]

	final_state = c.get_table_contents()
	if final_state != ref_ans:
		print("Final state does not match expected state.")
